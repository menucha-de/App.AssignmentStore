...
import havis.custom.harting.assignmentstore.Environment;
...
import havis.custom.harting.assignmentstore.model.AssignmentRequest;
...
public class TestSuite {
	...
	public void init() throws Exception {
		...
		config.setDbConnection("jdbc:h2:mem:test;TRACE_LEVEL_SYSTEM_OUT=3;INIT=RUNSCRIPT FROM 'target/deb/opt/havis-apps/conf/havis/custom/harting/assignmentstore/assignmentstore.sql'");
